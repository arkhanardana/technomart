      ...
      <div className="grid grid-cols-5 gap-[30px]">
        {brands.map((item) => (
          <Link key={`${item.id + item.logo}`} href="#" className="logo-card">
            <div className="bg-white flex items-center flex-col justify-center p-[30px_20px] rounded-[20px] ring-1 ring-[#E5E5E5] hover:ring-2 hover:ring-[#FFC736] transition-all duration-300 w-full">
              <div className="w-full h-[70px] flex shrink-0 flex-col items-center justify-center overflow-hidden">
                <Image
                  src={item.logo}
