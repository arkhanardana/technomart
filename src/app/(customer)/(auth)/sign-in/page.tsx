      ...
      <div className="container max-w-[1130px] mx-auto flex flex-1 items-center justify-center py-5">
        ...
        >
          <div className="flex justify-center mb-6">
            <Image src="./assets/logos/logo-black.svg" alt="logo" width={140} height={140} />
          </div>
          ...
          <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
            <div className="flex shrink-0">
              <Image src="./assets/icons/sms.svg" alt="icon" width={17} height={17} />
            </div>
            <input
              type="email"
              id="email"
          ...
          <div className="flex flex-col gap-[10px]">
            <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
              <div className="flex shrink-0">
                <Image src="./assets/icons/lock.svg" alt="icon" width={17} height={17} />
              </div>
              <input
              ...
              />
              <button type="button" className="flex shrink-0" onClick={handleShowPassword}>
